...
feature 'Candidate view your interviews' do
  context 'successfully' do
    before :each do
      ...
      create(:apply_job, job_opportunity: job_opportunity, candidate: candidate)
      create(:apply_job, job_opportunity: job_opportunity_b, candidate: candidate)
      create(:apply_job, job_opportunity: job_opportunity_c, candidate: candidate)

      create(:interview, job_opportunity: job_opportunity, candidate: candidate,
                                     interview_date: '21/05/2021', hour: '15:30',
                                     address: 'Rua Vergueiro, 11')
      create(:interview, job_opportunity: job_opportunity_b, candidate: candidate,
