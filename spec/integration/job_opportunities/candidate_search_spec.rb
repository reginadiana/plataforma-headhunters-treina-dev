...
feature 'Candidate visit list of jobs' do
  context 'successfully' do
    before :each do
      ...
      create(:job_opportunity, title: 'Desenvolvedor Frontend', skills: 'React, Java Script e Linux')
      create(:job_opportunity, title: 'Desenvolvedor Backend', skills: 'Rails, Postgresql e Linux')
